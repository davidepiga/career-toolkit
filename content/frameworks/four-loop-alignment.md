---
title: "Four-Loop Alignment"
description: "A diagram exercise that puts your personal Values, Purpose, Motivation, and Impact alongside your organisation's, and looks for the intersection points. You will not align on all four."
type: framework
dimension: Direction
dimension_type: stage
presenter: "Hannah Nash"
agency: "10Eighty"
...
1. **Pull the inputs.** Personal purpose statement, organisation's published vision, mission, values; your team's objectives; your job description.
2. **Draw the four overlapping pairs of circles.** One pair per dimension.
3. **Fill in the personal side.** Honest, not aspirational. What you actually value and want, not what you would say in a job interview.
4. **Fill in the organisational side.** Verbatim where possible from the published documents; paraphrased where the documents are vague.
5. **Mark the intersection points.** Specific overlaps, named in plain language.
6. **Run the cascade as the upstream check.** Vision down to your job description; reverse arrow up.
7. **Identify the deliberate moves.** For each connection point, name one thing you can do this quarter to lean on it. For each weak alignment, decide whether to design around it or to start exploring alternatives.
8. **Re-run quarterly during change.** Both sides shift.
