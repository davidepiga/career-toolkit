...
description: "A four-quadrant model that maps your abilities against energy and current use, with a sharp definition of what counts as a strength: it must energise you, you must perform it well, and you must use it."
type: framework
dimension: Mindset
dimension_type: foundation
presenter: "Mirka Packard, Jesús Guerrero, Shihui Xu"
agency: "IMO, UNOG, UNDP"
session: "Use Your Strengths to Boost Your Career"
session_slug: "cw-day-4-session-5"
...
tags:
  ...
  - capability
aliases:
  - Realised vs Unrealised Strengths
  - Strengths Quadrant Map
  - Strength Formula
  - Talent x Investment
related:
...
- Optional: the [Strengths Profile Free Starter Assessment](https://www.strengthsprofile.com) as a follow-up to validate or deepen what you find.
