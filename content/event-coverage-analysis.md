---
title: "Event Coverage Analysis"
description: "Two readings of the IACW 2026: what the programme covered against the Career Navigation Model, and who was on stage."
type: audit
tags: []
status: published
...
This is not a criticism of the speakers, who were credible, prepared, and generous with their content. It is an observation about the design of the event: a career-week programme run by L&D and HR functions of UN organisations will, by definition, surface their perspective. The toolkit was built on top of what was offered. The parallel research conversations described on the [About](about) page are the attempt to surface what was missing.
