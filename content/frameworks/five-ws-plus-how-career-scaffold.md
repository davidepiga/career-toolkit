---
title: "Five Ws Plus How, Career Scaffold"
description: "Six question prompts (Who, What, Where, When, Why, How) for breaking career-related analysis paralysis into a finite list of things to find out."
type: framework
dimension: Direction
dimension_type: stage
presenter: "Liz Oseland, Hannah Nash"
agency: "10Eighty"
session: "Own Your Future, Make Your Role Matter"
session_slug: "cw-day-5-session-8"
...
1. **Take the prompts in any order.** Some people work better starting with Why, others with Who. The order does not matter.
2. **Write every question that comes to mind.** Do not edit. Do not pre-judge whether a question is "good". The unfiltered list is the raw material.
3. **Group into columns.** Each question goes under one of the six headings.
4. **Check coverage.** Is one column conspicuously empty? That is often the dimension you are avoiding. Spend an extra five minutes adding questions there.
5. **Mark the three to five questions you most need answered.** Out of the long list, choose the small set that would open up the most.
6. **For each chosen question, name the next concrete action.** Not "think about this". A specific thing you will do this week, with a date.
7. **Run the actions.** The scaffold's value is in the conversion: from vague anxiety to a finite list to specific moves you can complete.
