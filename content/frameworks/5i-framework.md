---
title: "5i Framework"
description: "A five-dimension coaching framework for making informed career decisions: Identify values, set Intentional goals, take Inventory of skills, plan Investment, name Inhibitors."
type: framework
dimension: Direction
dimension_type: stage
presenter: "Erin Bowser, Shihui Xu"
agency: "IOM, UNDP"
...
tags:
  ...
  - skills-audit
aliases:
  - Five Dimensions of Career Development
  - IOM-UNDP 5i
related:
  - smarteer-goals
  - skill-matrix-audit
...
*Tools.* The Work Values Card Sort (free at [icscareers.com.au/card-sort](https://www.icscareers.com.au/card-sort/)) presents 24 values you drag into priority tiers. Or any private list of values you write yourself.
...
- [Work Values Card Sort](https://www.icscareers.com.au/card-sort/), a free 24-value drag-and-drop tool for the Identify dimension.
- [MBTI](https://www.themyersbriggs.com/en-us/explore-solutions/mbti) (paid official, free imitations widely available), personality typology in 16 categories. Optional companion to Inventory.
- [DISC Profile](https://www.discprofile.com/what-is-disc) (free version available), behavioural and communication-style assessment. Optional companion to Inventory.
- [Cattell's 16PF](https://openpsychometrics.org/tests/16PF.php) (free version at openpsychometrics.org), personality questionnaire developed from Cattell's 1940s model.
