...
speakers:
  - name: "Katarina Posa"
    role: "Career Development and Transition Expert"
    agency: "IOM"
    bio_url: "https://learning.unog.ch/node/25708"
  - name: "Lucia Carrera"
    role: "Talent Management Specialist"
    agency: "WFP"
    bio_url: "https://learning.unog.ch/node/25709"
  - name: "Mirka Packard"
    role: "Head of Organisational Development"
    agency: "IMO"
    bio_url: "https://learning.unog.ch/node/25758"
...
frameworks:
  ...
  - saboteur-catalog
  - 20-80-bucket-system
session_url: "https://learning.unog.ch/node/25744"
tags:
  - session
  - day-3
  - mindset
...
- **Katarina Posa** · Career Development and Transition Expert, IOM · [Bio](https://learning.unog.ch/node/25708)
- **Lucia Carrera** · Talent Management Specialist, WFP · [Bio](https://learning.unog.ch/node/25709)
- **Mirka Packard** · Head of Organisational Development, IMO · [Bio](https://learning.unog.ch/node/25758)
...
| [[frameworks/notice-pause-shift-act\|Notice, Pause, Shift, Act]] | Four-step in-the-moment routine for shifting out of saboteur mode | When you feel a negative emotion: name the saboteur, breathe, ask a more open question from a sage mindset, then take one small constructive action |
| [[frameworks/saboteur-catalog\|Saboteur Catalog]] | Reference page for the 10 saboteurs (Judge plus 9 accomplices), with inner-voice patterns and counter-moves | Used as the lookup for step one of Notice-Pause-Shift-Act; identify the dominant patterns under pressure |
| [[frameworks/20-80-bucket-system\|20-80 Bucket System]] | Divide tasks into two buckets: 20% requiring full excellence, 80% where good enough is sufficient | Before starting any task, assign it to a bucket. Reserve your best energy for the 20%; release the perfectionism for the 80% |

## Resources

| Resource | What it is / What it's for | Link |
|----------|-----------------------------|------|
| Positive Intelligence self-assessment | Free online tool that identifies your top accomplice saboteurs based on your responses | https://www.positiveintelligence.com |
| Session worksheet | Speaker-created worksheet to apply the saboteur framework to your own career context | Shared in session chat |
| *Positive Intelligence* by Shirzad Chamin | The foundational book on the PQ framework; also available as talks on YouTube | Available via major booksellers |
