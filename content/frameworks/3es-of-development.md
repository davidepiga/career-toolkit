---
title: "3 E's of Development"
description: "A three-dimension check on any development plan: Experience (learning by doing), Exposure (learning through others), Education (structured learning). The strongest plans run all three."
type: framework
dimension: Pursuit
dimension_type: stage
presenter: "Sina Weinhuber"
agency: "UNV"
...
5. **Re-check monthly.** Skills move when all three dimensions stay active. The check is whether the dimensions are still alive, not whether the plan has changed.
