---
title: "Skills-in-Use CV Pattern"
description: "A writing pattern for CV bullets, cover-letter sentences, and interview answers. Name the skill, the action it enabled, and the context it produced impact in."
type: framework
dimension: Capability
dimension_type: foundation
presenter: "Rathan Kinhal, Olga Lehtinen"
agency: "EY Switzerland, UNICC"
session: "Upskilling for the Future"
session_slug: "cw-day-3-session-2"
...
tags:
  ...
  - skills
aliases:
  - Because of X I Delivered Y
  - Skill in Use Bullet
  - Capability Language Rewrite
related:
...
**Generic, weak bullet:**
"Responsible for project management and stakeholder engagement on a multi-country health programme."

This has neither outcome nor specific skill. Reads as a duty list.

**Skills-in-Use rewrite:**
"Because of multi-country results-based programme management, I delivered baseline data three weeks ahead of plan with 92% completeness across three pillars in a six-country gender-equality flagship programme, allowing the mid-term evaluation to proceed on schedule."
...
**Skills-in-Use rewrite:**
"Because of multilingual stakeholder negotiation, I led the drafting and signing of memoranda of understanding with health ministries across six West African countries, securing programme sign-off in 11 weeks against an 18-week target."

Skill, outcome (six MoUs signed, 11 weeks against 18), context (West African health ministries).

**Generic, weak bullet:**
"Used AI tools to improve team productivity."

Reads as buzzword. Skill is too generic; outcome and context absent.

**Skills-in-Use rewrite:**
"Because of prompt-engineering and Power BI integration, I built a partner-reporting dashboard that cut quarterly report preparation time from 14 person-days to 2, freeing the team to expand monitoring coverage by two countries."
