...
type: session
slug: cw-day-3-session-3
day: 3
session_number: 3
session_date: 2026-05-06
session_time: "12:00 CEST"
language: en
hosted_by:
  - "UNV"
  - "UNICEF"
speakers:
  - name: "Rolf Reinhardt"
    ...
    agency: "LinkedIn"
    bio_url: "https://learning.unog.ch/node/25640"
  - name: "Tom Frohner"
    role: "Senior Customer Success Manager"
    agency: "LinkedIn"
    bio_url: "https://learning.unog.ch/node/25641"
  - name: "Godwin Otim"
    role: "People and Culture Specialist"
    agency: "UNICEF"
    bio_url: "https://learning.unog.ch/node/25485"
...
session_url: "https://learning.unog.ch/node/25740"
tags:
  - session
  - day-3
  - pursuit
...
- **Rolf Reinhardt** · Senior Account Director, LinkedIn · [Bio](https://learning.unog.ch/node/25640)
- **Tom Frohner** · Senior Customer Success Manager, LinkedIn · [Bio](https://learning.unog.ch/node/25641)
- **Godwin Otim** · People and Culture Specialist, UNICEF · [Bio](https://learning.unog.ch/node/25485)
...
|------|--------------------|---------------|
| STAR Method *(referenced, no separate framework page)* | Situation, Task, Action, Result | Structure examples of past experience in CVs, cover letters, and interviews to demonstrate specific evidence rather than generic claims. *(Considered for promotion to a framework page but not promoted: STAR is closely related to the [[frameworks/r-car\|R-CAR]] and [[frameworks/skills-in-use-cv-pattern\|Skills-in-Use CV Pattern]] pages, which cover the same competency-statement structure with more operational detail. Use those.)* |
| [[frameworks/3es-of-development\|3 E's of Development]] | Experience, Exposure, Education | Plan professional development across all three dimensions: learning by doing (new tasks), learning through others (mentors, feedback), and structured learning (courses, AI tools). Most AI tools cover only the Education layer; plan for all three |
| [[frameworks/career-gap-to-sprint-workflow\|Career Gap to Sprint Workflow]] | Two-prompt AI workflow: structured fit analysis, then 30-day calendar-blocked development sprint | Run prompt 1 with your CV and a target JD to produce a gap map; run prompt 2 to convert the map into an ICS-exportable sprint plan. Re-run prompt 1 on day 28 to test whether the gap closed |
| [[frameworks/ai-roleplay-for-skill-practice\|AI Roleplay for Skill Practice]] | Practice routine using AI personas to rehearse high-stakes conversations before they happen for real | Define scenario, persona, and rubric; run multiple rounds; collect structured feedback; iterate. Free for all LinkedIn users; same approach works on any general-purpose AI |
| [[frameworks/ai-prompting-for-learning\|AI Prompting for Learning]] | Three principles for getting useful learning support from any AI: be specific about your level, ask for structure, push it deeper | Use whenever you ask an AI to help you learn something. Pair the AI output with an immediate Experience commitment to keep it from staying in the Education-only layer |
| [[frameworks/evidence-vs-polish-diagnostic\|Evidence vs Polish Diagnostic]] | Recruiter-side question: if all polished language was stripped from this CV, what evidence would remain? | Run before submitting any application, after the Career Gap to Sprint Workflow and the Third Eye Principle review |
