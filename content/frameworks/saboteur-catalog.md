---
title: "Saboteur Catalog"
description: "A reference for the ten saboteur patterns from the Positive Intelligence framework: one master saboteur (the Judge) plus nine accomplices, each with an inner-voice signature and a specific counter-move."
type: reference
dimension: Mindset
dimension_type: foundation
presenter: "Mirka Packard, Lucia Carrera, Katarina Posa"
agency: "IMO, WFP, IOM"
...
Introduced collectively by Mirka Packard (IMO), Lucia Carrera (WFP), and Katarina Posa (IOM) at the [[sessions/cw-day-3-session-5|Managing Your Saboteurs]] session of the UN Inter-Agency Career Week 2026, on 6 May 2026. The ten saboteurs come directly from the Positive Intelligence framework by Shirzad Chamine, drawn from a research base of roughly one million participants. The free [Positive Intelligence self-assessment](https://www.positiveintelligence.com) identifies your top accomplices.
...
- As a one-off self-diagnostic, ideally paired with the free [Positive Intelligence assessment](https://www.positiveintelligence.com).
