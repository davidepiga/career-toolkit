...
description: "A structured gap analysis between where you are now and where you want to go, broken down into skills, network, and blockers, with three time-bounded next steps."
type: framework
dimension: Direction
dimension_type: stage
presenter: "Adina Forsstrom"
agency: "UNESCO"
session: "Career Development as a Psychosocial Hazard"
session_slug: "cw-day-3-session-7"
...
4. **Translate each gap into a small step.** Not "develop M&E skills" (vague) but "complete the LinkedIn Learning M&E track by end of June; volunteer to support the meta-evaluation working group for one quarter". Use [[micromobility-strategies|Micromobility Strategies]] as the menu of move types.
...
| Dimension | Current state | Desired state | Gap | First small step (this week) | Next step (this month) | Bigger step (next six months) |
|-----------|---------------|---------------|-----|------------------------------|------------------------|-------------------------------|
...
- **This week.** Send three messages: to two G-to-P graduates she has heard about (network), and to her manager to schedule a [[career-conversation-playbook|Career Conversation]] about the role-vs-grade gap.
- **This month.** Enrol in the LinkedIn Learning M&E track. Volunteer for the country-office gender working group ([[micromobility-strategies|micromobility]], task force).
...
- **Mapping alone when the picture is unclear.** If you cannot articulate the desired state, the map is the wrong starting tool. Have a [[career-conversation-playbook|Career Conversation]] with a mentor first to clarify direction.
...
- [[micromobility-strategies|Micromobility Strategies]], the menu of move types that fill the steps column.
- [[career-conversation-playbook|Career Conversation Playbook]], the structure for the conversations that often follow the map.
- [[5i-framework|5i Framework]], the broader five-dimension structure when the question is wider than gap analysis.
- [[basic-achievement-bank|BASIC Achievement Bank]], the documentation tool that turns the steps into reusable application material.
