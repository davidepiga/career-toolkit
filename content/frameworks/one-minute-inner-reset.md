---
title: "One-Minute Inner Reset"
description: "A five-step body-first sequence for self-regulation in a challenging moment: pause, body scan, label the emotion, box breathing, choose a value-aligned action. Designed to fit into existing transitions."
type: framework
dimension: Mindset
...
1. **Pick the existing transition you will attach to.** Walking through a hallway, waiting for the kettle, sitting in your car before going inside. Be specific.
2. **Run the five steps in sequence.** Pause, scan, label, breathe, choose. Roughly 60 seconds total.
3. **Resume.** Do not extend the practice past one minute unless you choose to; the value compounds through repetition, not through length.
4. **Notice the change, even if small.** A slightly looser jaw. A breath that goes deeper. A clearer sense of what you actually want to do next.
5. **Repeat several times a day.** The brain rewires through frequency, not through the perfect single session. Aim for three or four resets across a typical workday.
