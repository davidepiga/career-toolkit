...
hosted_by:
  ...
  - "IOM"
speakers:
  - name: "Silvia Märkli García"
    role: "HR Officer"
    agency: "UN Women (New York HQ)"
    bio_url: "https://learning.unog.ch/node/25693"
  - name: "Virginie Ferré Sanchez-Macagno"
    role: "Learning and Development Trainer"
    agency: "UNOG (Geneva)"
    bio_url: "https://learning.unog.ch/node/25521"
primary_dimension: mindset
secondary_dimensions:
  - direction
  - capability
frameworks:
  - mentoring-conversation-cycle
  - how-to-approach-a-mentor
  - mentoring-vs-adjacent-practices
  - career-mapping
session_url: "https://learning.unog.ch/node/25749"
tags:
  - session
  - day-3
  - mindset
...
- **Silvia Märkli García** · HR Officer, UN Women (New York HQ) · [Bio](https://learning.unog.ch/node/25693)
- **Virginie Ferré Sanchez-Macagno** · Learning and Development Trainer, UNOG (Geneva) · [Bio](https://learning.unog.ch/node/25521)
...
|------|--------------------|---------------|
| [[frameworks/mentoring-conversation-cycle\|7-Step Mentoring Conversation Cycle]] | Establish trust, align expectations, listen actively, foster self-reflection, share experiences with permission, define concrete actions, evaluate learning | Use as a guide for structuring a mentoring conversation, especially useful for first-time mentors. Active listening and confidentiality are constants across all steps, not stages |
| [[frameworks/how-to-approach-a-mentor\|How to Approach a Mentor]] | Outreach structure for the first message to a potential mentor: clarify your objective first, look beyond hierarchy, brief specific message with the "hook", propose a light bounded commitment | Use when reaching out to anyone you want to learn from. The hardest step is sending; once you do, people are generally generous |
| [[frameworks/mentoring-vs-adjacent-practices\|Mentoring vs Adjacent Practices]] | Distinctions between mentoring, coaching, consulting, and counselling | Use when deciding which kind of support you need or are equipped to offer. Useful mid-conversation if the territory shifts |
| Current State / Gap / Future State *(absorbed, no separate framework page)* | A three-part model: where is the mentee now, where do they want to be, what is the gap | Useful as a mental anchor when you feel uncertain as a mentor. *(Considered for promotion to a framework page but not promoted: the operational version of this model is the [[frameworks/career-mapping\|Career Mapping]] framework, which covers the same idea with more structure. The mental-anchor framing remains useful within the mentoring conversation cycle.)* |
