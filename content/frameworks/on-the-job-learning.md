...
description: "A structured way to make onboarding, reassignment, parental leave replacement, and partial handovers into designed learning events. Mentoring Plan Map plus a Skills + Mindset + Toolkit prep frame."
type: framework
dimension: Capability
dimension_type: foundation
presenter: "Paola Pinto"
agency: "UN Global Service Centre"
session: "Mentoring 2.0, From Top-Down to All-Around"
session_slug: "cw-day-5-session-6"
...
1. **Identify the moment.** A new colleague is arriving, a reassignment is happening, a separation is coming. Decide deliberately to structure it.
2. **Identify the mentor.** A more experienced colleague who has the relevant knowledge, demonstrates strong communication skills, and has the commitment to transmit learning. Seniority alone is not the criterion.
3. **Mentor prep.** Skills + Mindset + Toolkit. If a workshop is available, take it. If not, work through the prep manually.
4. **First conversation between mentor and mentee.** Run the Scan together. The mentee's voice is essential here; do not present a Scan you have already completed.
5. **Set SMART goals based on the Scan.** Co-create. Time-bound. Revisitable.
6. **Design the Personalised plan.** Sequence of tasks, embedded learning moments, feedback rhythm, checkpoints.
7. **Run the cadence.** Weekly to fortnightly check-ins for the first three months, then taper. Adjust the plan as needs evolve.
8. **Close.** End the OJL relationship deliberately, with a final review of what was learned, what is still in progress, and how the mentee will continue.
