---
title: "Feeling Wheel"
description: "A circular reference for naming emotions with precision. Combined with the formula 'I am noticing that I am feeling...', the wheel turns vague emotional discomfort into specific, regulable information."
type: framework
dimension: Mindset
dimension_type: foundation
presenter: "Rengin Isik Akin"
agency: "UNFCCC"
session: "Leading from Within"
session_slug: "cw-day-4-session-3"
...
1. **Notice that something has shifted.** A tightness, a pull, a heaviness, a buzzing. The first move is awareness that something is there.
2. **Open the wheel.** Or call the version you remember to mind.
3. **Start with the core ring.** Which of the primary emotions is closest? Often more than one is present; pick the strongest first.
4. **Move outward.** From the core, find the more specific variant. Not "angry" but "resentful" or "frustrated" or "hurt-and-angry-at-the-same-time".
5. **Name it with the formula.** Out loud or silently. *"I am noticing that I am feeling resentful."* Notice what shifts when you say it.
6. **Ask what the feeling is signalling.** Emotions are data. What unmet need or crossed value is being pointed at? *"I feel resentful because the contribution I made was not acknowledged. The unmet need is recognition."*
7. **Choose a response.** Knowing the precise emotion and what it is signalling, what is the next best step? Sometimes it is a conversation; sometimes it is a boundary; sometimes it is just letting the feeling pass without acting on it.
